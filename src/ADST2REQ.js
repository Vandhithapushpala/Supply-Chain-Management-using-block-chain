...
const Adstreq2 = () => {
    ...
    const ac1 = async () => {
        ...
        if (n1 == 0) {
            await window.contract.methods.resreq(["ADST2", "ADST1", "1"]).send({ from: account });
            n1++;
        }
    ...
    const ac2 = async () => {
        ...
        if (n2 == 0) {
            await window.contract.methods.resreq(["ADST2", "ADST3", "1"]).send({ from: account });
            n2++;
        }
    ...
    const re1 = async () => {
        ...
        if (n3 == 0) {
            ...
            await window.contract.methods.resreq(["ADST2", "ADST1", "0"]).send({ from: account });
            n3++;
        }
    ...
    const re2 = async () => {
        ...
        if (n4 == 0) {
            ...
            await window.contract.methods.resreq(["ADST2", "ADST3", "0"]).send({ from: account });
            n4++;
        }
